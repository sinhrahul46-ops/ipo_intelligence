...
.block-container {padding-top: 20px; padding-bottom: 20px; max-width: 430px;}
...
.ledger i {flex:1;} .ledger i.fact {background:var(--good);} .ledger i.cross {background:#2B8F5B;} .ledger i.conflict {background:var(--bad);} .ledger i.unverified {background:var(--gray);}
...
.tag.mainboard {background:var(--brand-soft); color:#9FB8F5;} .tag.sme {background:#332F14; color:#E4CE6D;}
...
### 📊 AI Summary
{ipo.get('ai_summary', 'No summary available.')}
        """)
